...
public sealed class OpenBlasOperations : IBlasOperations
{
    public static readonly OpenBlasOperations Default = new();
    ...
    {
        var result = cblas_cdotu(n, x, incX, y, incY);
        Unsafe.Copy(ref result, dotc);
    }
    ...
    {
        return (int)cblas_idmax(n, x, incX);
    }

    public unsafe int Idmin(int n, double* x, int incX)
    {
        return (int)cblas_idmin(n, x, incX);
    }
    ...
    {
        return (int)cblas_ismax(n, x, incX);
    }

    public unsafe int Ismin(int n, float* x, int incX)
    {
        return (int)cblas_ismin(n, x, incX);
    }
