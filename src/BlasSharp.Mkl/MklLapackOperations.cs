using static BlasSharp.Mkl.NativeMethods;

namespace BlasSharp.Mkl;

public sealed class MklLapackOperations : ILapackOperations
{
    public static readonly MklLapackOperations Default = new();
    ...
    {
        cbdsqr_(uplo, n, ncvt, nru, ncc, d, e, (_MKL_Complex8*)vt, ldvt, (_MKL_Complex8*)u, ldu, (_MKL_Complex8*)c, ldc, work, info);
    }
    ...
    {
        cgbcon_(norm, n, kl, ku, (_MKL_Complex8*)ab, ldab, ipiv, anorm, rcond, (_MKL_Complex8*)work, rwork, info);
    }
    ...
    {
        cgbequ_(m, n, kl, ku, (_MKL_Complex8*)ab, ldab, r, c, rowcnd, colcnd, amax, info);
    }
    ...
    {
        cgbrfs_(trans, n, kl, ku, nrhs, (_MKL_Complex8*)ab, ldab, (_MKL_Complex8*)afb, ldafb, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cgbsv(int* n, int* kl, int* ku, int* nrhs, void* ab, int* ldab, int* ipiv, void* b, int* ldb, int* info)
    {
        cgbsv_(n, kl, ku, nrhs, (_MKL_Complex8*)ab, ldab, ipiv, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        cgbsvx_(fact, trans, n, kl, ku, nrhs, (_MKL_Complex8*)ab, ldab, (_MKL_Complex8*)afb, ldafb, ipiv, equed, r, c, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cgbtrf(int* m, int* n, int* kl, int* ku, void* ab, int* ldab, int* ipiv, int* info)
    {
        cgbtrf_(m, n, kl, ku, (_MKL_Complex8*)ab, ldab, ipiv, info);
    }

    public unsafe void Cgbtrs(byte* trans, int* n, int* kl, int* ku, int* nrhs, void* ab, int* ldab, int* ipiv, void* b, int* ldb, int* info)
    {
        cgbtrs_(trans, n, kl, ku, nrhs, (_MKL_Complex8*)ab, ldab, ipiv, (_MKL_Complex8*)b, ldb, info);
    }

    public unsafe void Cgebrd(int* m, int* n, void* a, int* lda, float* d, float* e, void* tauq, void* taup, void* work, int* lwork, int* info)
    {
        cgebrd_(m, n, (_MKL_Complex8*)a, lda, d, e, (_MKL_Complex8*)tauq, (_MKL_Complex8*)taup, (_MKL_Complex8*)work, lwork, info);
    }

    public unsafe void Cgecon(byte* norm, int* n, void* a, int* lda, float* anorm, float* rcond, void* work, float* rwork, int* info)
    {
        cgecon_(norm, n, (_MKL_Complex8*)a, lda, anorm, rcond, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cgeequ(int* m, int* n, void* a, int* lda, float* r, float* c, float* rowcnd, float* colcnd, float* amax, int* info)
    {
        cgeequ_(m, n, (_MKL_Complex8*)a, lda, r, c, rowcnd, colcnd, amax, info);
    }
    ...
    {
        cgees_(jobvs, sort, (delegate* unmanaged[Cdecl]<_MKL_Complex8*, int>)select, n, (_MKL_Complex8*)a, lda, sdim, (_MKL_Complex8*)w, (_MKL_Complex8*)vs, ldvs, (_MKL_Complex8*)work, lwork, rwork, bwork, info);
    }
    ...
    {
        cgeev_(jobvl, jobvr, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)w, (_MKL_Complex8*)vl, ldvl, (_MKL_Complex8*)vr, ldvr, (_MKL_Complex8*)work, lwork, rwork, info);
    }

    public unsafe void Cgehrd(int* n, int* ilo, int* ihi, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        cgehrd_(n, ilo, ihi, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, lwork, info);
    }

    public unsafe void Cgels(byte* trans, int* m, int* n, int* nrhs, void* a, int* lda, void* b, int* ldb, void* work, int* lwork, int* info)
    {
        cgels_(trans, m, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        cgelsd_(m, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, s, rcond, rank, (_MKL_Complex8*)work, lwork, rwork, iwork, info);
    }
    ...
    {
        cgelss_(m, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, s, rcond, rank, (_MKL_Complex8*)work, lwork, rwork, info);
    }
    ...
    {
        cgelsy_(m, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, jpvt, rcond, rank, (_MKL_Complex8*)work, lwork, rwork, info);
    }

    public unsafe void Cgeqp3(int* m, int* n, void* a, int* lda, int* jpvt, void* tau, void* work, int* lwork, float* rwork, int* info)
    {
        cgeqp3_(m, n, (_MKL_Complex8*)a, lda, jpvt, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, lwork, rwork, info);
    }

    public unsafe void Cgeqr2(int* m, int* n, void* a, int* lda, void* tau, void* work, int* info)
    {
        cgeqr2_(m, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, info);
    }

    public unsafe void Cgeqrf(int* m, int* n, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        cgeqrf_(m, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        cgerfs_(trans, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)af, ldaf, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }
    ...
    {
        cgesdd_(jobz, m, n, (_MKL_Complex8*)a, lda, s, (_MKL_Complex8*)u, ldu, (_MKL_Complex8*)vt, ldvt, (_MKL_Complex8*)work, lwork, rwork, iwork, info);
    }

    public unsafe int Cgesv(int* n, int* nrhs, void* a, int* lda, int* ipiv, void* b, int* ldb, int* info)
    {
        cgesv_(n, nrhs, (_MKL_Complex8*)a, lda, ipiv, (_MKL_Complex8*)b, ldb, info);
        return *info;
    }
    ...
    {
        cgesvd_(jobu, jobvt, m, n, (_MKL_Complex8*)a, lda, s, (_MKL_Complex8*)u, ldu, (_MKL_Complex8*)vt, ldvt, (_MKL_Complex8*)work, lwork, rwork, info);
    }
    ...
    {
        cgesvx_(fact, trans, n, nrhs, (_MKL_Complex8*)ab, ldab, (_MKL_Complex8*)afb, ldafb, ipiv, equed, r, c, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cgetf2(int* m, int* n, void* a, int* lda, int* ipiv, int* info)
    {
        cgetf2_(m, n, (_MKL_Complex8*)a, lda, ipiv, info);
    }

    public unsafe void Cgetrf(int* m, int* n, void* a, int* lda, int* ipiv, int* info)
    {
        cgetrf_(m, n, (_MKL_Complex8*)a, lda, ipiv, info);
    }

    public unsafe void Cgetri(int* n, void* a, int* lda, int* ipiv, void* work, int* lwork, int* info)
    {
        cgetri_(n, (_MKL_Complex8*)a, lda, ipiv, (_MKL_Complex8*)work, lwork, info);
    }

    public unsafe void Cgetrs(byte* trans, int* n, int* nrhs, void* a, int* lda, int* ipiv, void* b, int* ldb, int* info)
    {
        cgetrs_(trans, n, nrhs, (_MKL_Complex8*)a, lda, ipiv, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        cgges_(jobvsl, jobvsr, sort, selctg, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, sdim, (_MKL_Complex8*)alpha, (_MKL_Complex8*)beta, (_MKL_Complex8*)vsl, ldvsl, (_MKL_Complex8*)vsr, ldvsr, (_MKL_Complex8*)work, lwork, rwork, bwork, info);
    }
    ...
    {
        cggev_(jobvl, jobvr, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)alpha, (_MKL_Complex8*)beta, (_MKL_Complex8*)vl, ldvl, (_MKL_Complex8*)vr, ldvr, (_MKL_Complex8*)work, lwork, rwork, info);
    }
    ...
    {
        cggglm_(n, m, p, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)d, (_MKL_Complex8*)x, (_MKL_Complex8*)y, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        cgglse_(m, n, p, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)c, (_MKL_Complex8*)d, (_MKL_Complex8*)x, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        cggsvd_(jobu, jobv, jobq, m, n, p, k, l, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, alpha, beta, (_MKL_Complex8*)u, ldu, (_MKL_Complex8*)v, ldv, (_MKL_Complex8*)q, ldq, (_MKL_Complex8*)work, rwork, iwork, info);
    }
    ...
    {
        cgtcon_(norm, n, (_MKL_Complex8*)dl, (_MKL_Complex8*)d, (_MKL_Complex8*)du, (_MKL_Complex8*)du2, ipiv, anorm, rcond, (_MKL_Complex8*)work, info);
    }
    ...
    {
        cgtrfs_(trans, n, nrhs, (_MKL_Complex8*)dl, (_MKL_Complex8*)d, (_MKL_Complex8*)du, (_MKL_Complex8*)dlf, (_MKL_Complex8*)df, (_MKL_Complex8*)duf, (_MKL_Complex8*)du2, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cgtsv(int* n, int* nrhs, void* dl, void* d, void* du, void* b, int* ldb, int* info)
    {
        cgtsv_(n, nrhs, (_MKL_Complex8*)dl, (_MKL_Complex8*)d, (_MKL_Complex8*)du, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        cgtsvx_(fact, trans, n, nrhs, (_MKL_Complex8*)dl, (_MKL_Complex8*)d, (_MKL_Complex8*)du, (_MKL_Complex8*)dlf, (_MKL_Complex8*)df, (_MKL_Complex8*)duf, (_MKL_Complex8*)du2, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cgttrf(int* n, void* dl, void* d, void* du, void* du2, int* ipiv, int* info)
    {
        cgttrf_(n, (_MKL_Complex8*)dl, (_MKL_Complex8*)d, (_MKL_Complex8*)du, (_MKL_Complex8*)du2, ipiv, info);
    }

    public unsafe void Cgttrs(byte* trans, int* n, int* nrhs, void* dl, void* d, void* du, void* du2, int* ipiv, void* b, int* ldb, int* info)
    {
        cgttrs_(trans, n, nrhs, (_MKL_Complex8*)dl, (_MKL_Complex8*)d, (_MKL_Complex8*)du, (_MKL_Complex8*)du2, ipiv, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        chbgv_(jobz, uplo, n, ka, kb, (_MKL_Complex8*)ab, ldab, (_MKL_Complex8*)bb, ldbb, w, (_MKL_Complex8*)z, ldz, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cheev(byte* jobz, byte* uplo, int* n, void* a, int* lda, float* w, void* work, int* lwork, float* rwork, int* info)
    {
        cheev_(jobz, uplo, n, (_MKL_Complex8*)a, lda, w, (_MKL_Complex8*)work, lwork, rwork, info);
    }
    ...
    {
        cheevd_(jobz, uplo, n, (_MKL_Complex8*)a, lda, w, (_MKL_Complex8*)work, lwork, rwork, lrwork, iwork, liwork, info);
    }
    ...
    {
        chegv_(itype, jobz, uplo, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, w, (_MKL_Complex8*)work, lwork, rwork, info);
    }
    ...
    {
        chegvd_(itype, jobz, uplo, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, w, (_MKL_Complex8*)work, lwork, rwork, lrwork, iwork, liwork, info);
    }

    public unsafe void Chesv(byte* uplo, int* n, int* nrhs, void* a, int* lda, int* ipiv, void* b, int* ldb, void* work, int* lwork, int* info)
    {
        chesv_(uplo, n, nrhs, (_MKL_Complex8*)a, lda, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        chesvx_(fact, uplo, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)af, ldaf, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, lwork, rwork, info);
    }

    public unsafe void Chetrd(byte* uplo, int* n, void* a, int* lda, float* d, float* e, void* tau, void* work, int* lwork, int* info)
    {
        chetrd_(uplo, n, (_MKL_Complex8*)a, lda, d, e, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        chpgv_(itype, jobz, uplo, n, (_MKL_Complex8*)ap, (_MKL_Complex8*)bp, w, (_MKL_Complex8*)z, ldz, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Chpsv(byte* uplo, int* n, int* nrhs, void* ap, int* ipiv, void* b, int* ldb, int* info)
    {
        chpsv_(uplo, n, nrhs, (_MKL_Complex8*)ap, ipiv, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        chpsvx_(fact, uplo, n, nrhs, (_MKL_Complex8*)ap, (_MKL_Complex8*)afp, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }
    ...
    {
        cpbsvx_(fact, uplo, n, kd, nrhs, (_MKL_Complex8*)ab, ldab, (_MKL_Complex8*)afb, ldafb, equed, s, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cpocon(byte* uplo, int* n, void* a, int* lda, float* anorm, float* rcond, void* work, float* rwork, int* info)
    {
        cpocon_(uplo, n, (_MKL_Complex8*)a, lda, anorm, rcond, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cpoequ(int* n, void* a, int* lda, float* s, float* scond, float* amax, int* info)
    {
        cpoequ_(n, (_MKL_Complex8*)a, lda, s, scond, amax, info);
    }
    ...
    {
        cporfs_(uplo, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)af, ldaf, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cposv(byte* uplo, int* n, int* nrhs, void* a, int* lda, void* b, int* ldb, int* info)
    {
        cposv_(uplo, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        cposvx_(fact, uplo, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)af, ldaf, equed, s, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cpotf2(byte* uplo, int* n, void* a, int* lda, int* info)
    {
        cpotf2_(uplo, n, (_MKL_Complex8*)a, lda, info);
    }

    public unsafe void Cpotrf(byte* uplo, int* n, void* a, int* lda, int* info)
    {
        cpotrf_(uplo, n, (_MKL_Complex8*)a, lda, info);
    }

    public unsafe void Cpotri(byte* uplo, int* n, void* a, int* lda, int* info)
    {
        cpotri_(uplo, n, (_MKL_Complex8*)a, lda, info);
    }

    public unsafe void Cpotrs(byte* uplo, int* n, int* nrhs, void* a, int* lda, void* b, int* ldb, int* info)
    {
        cpotrs_(uplo, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)b, ldb, info);
    }

    public unsafe void Cppsv(byte* uplo, int* n, int* nrhs, void* ap, void* b, int* ldb, int* info)
    {
        cppsv_(uplo, n, nrhs, (_MKL_Complex8*)ap, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        cppsvx_(fact, uplo, n, nrhs, (_MKL_Complex8*)ap, (_MKL_Complex8*)afp, equed, s, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Cptsv(int* n, int* nrhs, float* d, void* e, void* b, int* ldb, int* info)
    {
        cptsv_(n, nrhs, d, (_MKL_Complex8*)e, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        cptsvx_(fact, n, nrhs, d, (_MKL_Complex8*)e, df, (_MKL_Complex8*)ef, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }

    public unsafe void Crot(int* n, void* cx, int* incx, void* cy, int* incy, float* c, void* s)
    {
        crot_(n, (_MKL_Complex8*)cx, incx, (_MKL_Complex8*)cy, incy, c, (_MKL_Complex8*)s);
    }

    public unsafe void Cspmv(byte* uplo, int* n, void* alpha, void* ap, void* x, int* incx, void* beta, void* y, int* incy)
    {
        cspmv_(uplo, n, (_MKL_Complex8*)alpha, (_MKL_Complex8*)ap, (_MKL_Complex8*)x, incx, (_MKL_Complex8*)beta, (_MKL_Complex8*)y, incy);
    }

    public unsafe void Cspr(byte* uplo, int* n, void* alpha, void* x, int* incx, void* ap)
    {
        cspr_(uplo, n, (_MKL_Complex8*)alpha, (_MKL_Complex8*)x, incx, (_MKL_Complex8*)ap);
    }

    public unsafe void Cspsv(byte* uplo, int* n, int* nrhs, void* ap, int* ipiv, void* b, int* ldb, int* info)
    {
        cspsv_(uplo, n, nrhs, (_MKL_Complex8*)ap, ipiv, (_MKL_Complex8*)b, ldb, info);
    }
    ...
    {
        cspsvx_(fact, uplo, n, nrhs, (_MKL_Complex8*)ap, (_MKL_Complex8*)afp, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, rwork, info);
    }
    ...
    {
        cstedc_(compz, n, d, e, (_MKL_Complex8*)z, ldz, (_MKL_Complex8*)work, lwork, rwork, lrwork, iwork, liwork, info);
    }

    public unsafe void Csteqr(byte* compz, int* n, float* d, float* e, void* z, int* ldz, float* work, int* info)
    {
        csteqr_(compz, n, d, e, (_MKL_Complex8*)z, ldz, work, info);
    }

    public unsafe void Csymv(byte* uplo, int* n, void* alpha, void* a, int* lda, void* x, int* incx, void* beta, void* y, int* incy)
    {
        csymv_(uplo, n, (_MKL_Complex8*)alpha, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)x, incx, (_MKL_Complex8*)beta, (_MKL_Complex8*)y, incy);
    }

    public unsafe void Csyr(byte* uplo, int* n, void* alpha, void* x, int* incx, void* a, int* lda)
    {
        csyr_(uplo, n, (_MKL_Complex8*)alpha, (_MKL_Complex8*)x, incx, (_MKL_Complex8*)a, lda);
    }

    public unsafe void Csysv(byte* uplo, int* n, int* nrhs, void* a, int* lda, int* ipiv, void* b, int* ldb, void* work, int* lwork, int* info)
    {
        csysv_(uplo, n, nrhs, (_MKL_Complex8*)a, lda, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        csysvx_(fact, uplo, n, nrhs, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)af, ldaf, ipiv, (_MKL_Complex8*)b, ldb, (_MKL_Complex8*)x, ldx, rcond, ferr, berr, (_MKL_Complex8*)work, lwork, rwork, info);
    }

    public unsafe void Ctrti2(byte* uplo, byte* diag, int* n, void* a, int* lda, int* info)
    {
        ctrti2_(uplo, diag, n, (_MKL_Complex8*)a, lda, info);
    }

    public unsafe void Cung2r(int* m, int* n, int* k, void* a, int* lda, void* tau, void* work, int* info)
    {
        cung2r_(m, n, k, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, info);
    }

    public unsafe void Cungbr(byte* vect, int* m, int* n, int* k, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        cungbr_(vect, m, n, k, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, lwork, info);
    }

    public unsafe void Cunghr(int* n, int* ilo, int* ihi, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        cunghr_(n, ilo, ihi, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, lwork, info);
    }

    public unsafe void Cungqr(int* m, int* n, int* k, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        cungqr_(m, n, k, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, lwork, info);
    }

    public unsafe void Cungtr(byte* uplo, int* n, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        cungtr_(uplo, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        cunm2r_(side, trans, m, n, k, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)c, ldc, (_MKL_Complex8*)work, info);
    }
    ...
    {
        cunmqr_(side, trans, m, n, k, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)c, ldc, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        cunmtr_(side, uplo, trans, m, n, (_MKL_Complex8*)a, lda, (_MKL_Complex8*)tau, (_MKL_Complex8*)c, ldc, (_MKL_Complex8*)work, lwork, info);
    }
    ...
    {
        dgees_(jobvs, sort, (delegate* unmanaged[Cdecl]<double*, double*, int>)select, n, a, lda, sdim, wr, wi, vs, ldvs, work, lwork, bwork, info);
    }
    ...
    {
        dgges_(jobvsl, jobvsr, sort, selctg, n, a, lda, b, ldb, sdim, alphar, alphai, beta, vsl, ldvsl, vsr, ldvsr, work, lwork, bwork, info);
    }
    ...
    {
        return dzsum1_(n, (_MKL_Complex16*)cx, incx);
    }

    public unsafe int Icmax1(int* n, void* cx, int* incx)
    {
        return icmax1_(n, (_MKL_Complex8*)cx, incx);
    }
    ...
    {
        return izmax1_(n, (_MKL_Complex16*)cx, incx);
    }

    public unsafe int Lsame(byte* ca, byte* cb)
    {
        // lsame_ not available in MKL, implement basic comparison
        return (*ca == *cb) ? 1 : 0;
    }
    ...
    {
        return scsum1_(n, (_MKL_Complex8*)cx, incx);
    }
    ...
    {
        sgees_(jobvs, sort, (delegate* unmanaged[Cdecl]<float*, float*, int>)select, n, a, lda, sdim, wr, wi, vs, ldvs, work, lwork, bwork, info);
    }
    ...
    {
        sgges_(jobvsl, jobvsr, sort, selctg, n, a, lda, b, ldb, sdim, alphar, alphai, beta, vsl, ldvsl, vsr, ldvsr, work, lwork, bwork, info);
    }
    ...
    {
        zbdsqr_(uplo, n, ncvt, nru, ncc, d, e, (_MKL_Complex16*)vt, ldvt, (_MKL_Complex16*)u, ldu, (_MKL_Complex16*)c, ldc, work, info);
    }
    ...
    {
        zgbcon_(norm, n, kl, ku, (_MKL_Complex16*)ab, ldab, ipiv, anorm, rcond, (_MKL_Complex16*)work, rwork, info);
    }
    ...
    {
        zgbequ_(m, n, kl, ku, (_MKL_Complex16*)ab, ldab, r, c, rowcnd, colcnd, amax, info);
    }
    ...
    {
        zgbrfs_(trans, n, kl, ku, nrhs, (_MKL_Complex16*)ab, ldab, (_MKL_Complex16*)afb, ldafb, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zgbsv(int* n, int* kl, int* ku, int* nrhs, void* ab, int* ldab, int* ipiv, void* b, int* ldb, int* info)
    {
        zgbsv_(n, kl, ku, nrhs, (_MKL_Complex16*)ab, ldab, ipiv, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zgbsvx_(fact, trans, n, kl, ku, nrhs, (_MKL_Complex16*)ab, ldab, (_MKL_Complex16*)afb, ldafb, ipiv, equed, r, c, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zgbtrf(int* m, int* n, int* kl, int* ku, void* ab, int* ldab, int* ipiv, int* info)
    {
        zgbtrf_(m, n, kl, ku, (_MKL_Complex16*)ab, ldab, ipiv, info);
    }

    public unsafe void Zgbtrs(byte* trans, int* n, int* kl, int* ku, int* nrhs, void* ab, int* ldab, int* ipiv, void* b, int* ldb, int* info)
    {
        zgbtrs_(trans, n, kl, ku, nrhs, (_MKL_Complex16*)ab, ldab, ipiv, (_MKL_Complex16*)b, ldb, info);
    }

    public unsafe void Zgebrd(int* m, int* n, void* a, int* lda, double* d, double* e, void* tauq, void* taup, void* work, int* lwork, int* info)
    {
        zgebrd_(m, n, (_MKL_Complex16*)a, lda, d, e, (_MKL_Complex16*)tauq, (_MKL_Complex16*)taup, (_MKL_Complex16*)work, lwork, info);
    }

    public unsafe void Zgecon(byte* norm, int* n, void* a, int* lda, double* anorm, double* rcond, void* work, double* rwork, int* info)
    {
        zgecon_(norm, n, (_MKL_Complex16*)a, lda, anorm, rcond, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zgeequ(int* m, int* n, void* a, int* lda, double* r, double* c, double* rowcnd, double* colcnd, double* amax, int* info)
    {
        zgeequ_(m, n, (_MKL_Complex16*)a, lda, r, c, rowcnd, colcnd, amax, info);
    }
    ...
    {
        zgees_(jobvs, sort, (delegate* unmanaged[Cdecl]<_MKL_Complex16*, int>)select, n, (_MKL_Complex16*)a, lda, sdim, (_MKL_Complex16*)w, (_MKL_Complex16*)vs, ldvs, (_MKL_Complex16*)work, lwork, rwork, bwork, info);
    }
    ...
    {
        zgeev_(jobvl, jobvr, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)w, (_MKL_Complex16*)vl, ldvl, (_MKL_Complex16*)vr, ldvr, (_MKL_Complex16*)work, lwork, rwork, info);
    }

    public unsafe void Zgehrd(int* n, int* ilo, int* ihi, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        zgehrd_(n, ilo, ihi, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, lwork, info);
    }

    public unsafe void Zgels(byte* trans, int* m, int* n, int* nrhs, void* a, int* lda, void* b, int* ldb, void* work, int* lwork, int* info)
    {
        zgels_(trans, m, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zgelsd_(m, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, s, rcond, rank, (_MKL_Complex16*)work, lwork, rwork, iwork, info);
    }
    ...
    {
        zgelss_(m, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, s, rcond, rank, (_MKL_Complex16*)work, lwork, rwork, info);
    }
    ...
    {
        zgelsy_(m, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, jpvt, rcond, rank, (_MKL_Complex16*)work, lwork, rwork, info);
    }

    public unsafe void Zgeqp3(int* m, int* n, void* a, int* lda, int* jpvt, void* tau, void* work, int* lwork, double* rwork, int* info)
    {
        zgeqp3_(m, n, (_MKL_Complex16*)a, lda, jpvt, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, lwork, rwork, info);
    }

    public unsafe void Zgeqr2(int* m, int* n, void* a, int* lda, void* tau, void* work, int* info)
    {
        zgeqr2_(m, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, info);
    }

    public unsafe void Zgeqrf(int* m, int* n, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        zgeqrf_(m, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zgerfs_(trans, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)af, ldaf, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }
    ...
    {
        zgesdd_(jobz, m, n, (_MKL_Complex16*)a, lda, s, (_MKL_Complex16*)u, ldu, (_MKL_Complex16*)vt, ldvt, (_MKL_Complex16*)work, lwork, rwork, iwork, info);
    }

    public unsafe int Zgesv(int* n, int* nrhs, void* a, int* lda, int* ipiv, void* b, int* ldb, int* info)
    {
        zgesv_(n, nrhs, (_MKL_Complex16*)a, lda, ipiv, (_MKL_Complex16*)b, ldb, info);
        return *info;
    }
    ...
    {
        zgesvd_(jobu, jobvt, m, n, (_MKL_Complex16*)a, lda, s, (_MKL_Complex16*)u, ldu, (_MKL_Complex16*)vt, ldvt, (_MKL_Complex16*)work, lwork, rwork, info);
    }
    ...
    {
        zgesvx_(fact, trans, n, nrhs, (_MKL_Complex16*)ab, ldab, (_MKL_Complex16*)afb, ldafb, ipiv, equed, r, c, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zgetf2(int* m, int* n, void* a, int* lda, int* ipiv, int* info)
    {
        zgetf2_(m, n, (_MKL_Complex16*)a, lda, ipiv, info);
    }

    public unsafe void Zgetrf(int* m, int* n, void* a, int* lda, int* ipiv, int* info)
    {
        zgetrf_(m, n, (_MKL_Complex16*)a, lda, ipiv, info);
    }

    public unsafe void Zgetri(int* n, void* a, int* lda, int* ipiv, void* work, int* lwork, int* info)
    {
        zgetri_(n, (_MKL_Complex16*)a, lda, ipiv, (_MKL_Complex16*)work, lwork, info);
    }

    public unsafe void Zgetrs(byte* trans, int* n, int* nrhs, void* a, int* lda, int* ipiv, void* b, int* ldb, int* info)
    {
        zgetrs_(trans, n, nrhs, (_MKL_Complex16*)a, lda, ipiv, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zgges_(jobvsl, jobvsr, sort, (delegate* unmanaged[Cdecl]<_MKL_Complex16*, _MKL_Complex16*, int>)selctg, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, sdim, (_MKL_Complex16*)alpha, (_MKL_Complex16*)beta, (_MKL_Complex16*)vsl, ldvsl, (_MKL_Complex16*)vsr, ldvsr, (_MKL_Complex16*)work, lwork, rwork, bwork, info);
    }
    ...
    {
        zggev_(jobvl, jobvr, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)alpha, (_MKL_Complex16*)beta, (_MKL_Complex16*)vl, ldvl, (_MKL_Complex16*)vr, ldvr, (_MKL_Complex16*)work, lwork, rwork, info);
    }
    ...
    {
        zggglm_(n, m, p, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)d, (_MKL_Complex16*)x, (_MKL_Complex16*)y, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zgglse_(m, n, p, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)c, (_MKL_Complex16*)d, (_MKL_Complex16*)x, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zggsvd_(jobu, jobv, jobq, m, n, p, k, l, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, alpha, beta, (_MKL_Complex16*)u, ldu, (_MKL_Complex16*)v, ldv, (_MKL_Complex16*)q, ldq, (_MKL_Complex16*)work, rwork, iwork, info);
    }
    ...
    {
        zgtcon_(norm, n, (_MKL_Complex16*)dl, (_MKL_Complex16*)d, (_MKL_Complex16*)du, (_MKL_Complex16*)du2, ipiv, anorm, rcond, (_MKL_Complex16*)work, info);
    }
    ...
    {
        zgtrfs_(trans, n, nrhs, (_MKL_Complex16*)dl, (_MKL_Complex16*)d, (_MKL_Complex16*)du, (_MKL_Complex16*)dlf, (_MKL_Complex16*)df, (_MKL_Complex16*)duf, (_MKL_Complex16*)du2, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zgtsv(int* n, int* nrhs, void* dl, void* d, void* du, void* b, int* ldb, int* info)
    {
        zgtsv_(n, nrhs, (_MKL_Complex16*)dl, (_MKL_Complex16*)d, (_MKL_Complex16*)du, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zgtsvx_(fact, trans, n, nrhs, (_MKL_Complex16*)dl, (_MKL_Complex16*)d, (_MKL_Complex16*)du, (_MKL_Complex16*)dlf, (_MKL_Complex16*)df, (_MKL_Complex16*)duf, (_MKL_Complex16*)du2, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zgttrf(int* n, void* dl, void* d, void* du, void* du2, int* ipiv, int* info)
    {
        zgttrf_(n, (_MKL_Complex16*)dl, (_MKL_Complex16*)d, (_MKL_Complex16*)du, (_MKL_Complex16*)du2, ipiv, info);
    }

    public unsafe void Zgttrs(byte* trans, int* n, int* nrhs, void* dl, void* d, void* du, void* du2, int* ipiv, void* b, int* ldb, int* info)
    {
        zgttrs_(trans, n, nrhs, (_MKL_Complex16*)dl, (_MKL_Complex16*)d, (_MKL_Complex16*)du, (_MKL_Complex16*)du2, ipiv, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zhbgv_(jobz, uplo, n, ka, kb, (_MKL_Complex16*)ab, ldab, (_MKL_Complex16*)bb, ldbb, w, (_MKL_Complex16*)z, ldz, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zheev(byte* jobz, byte* uplo, int* n, void* a, int* lda, double* w, void* work, int* lwork, double* rwork, int* info)
    {
        zheev_(jobz, uplo, n, (_MKL_Complex16*)a, lda, w, (_MKL_Complex16*)work, lwork, rwork, info);
    }
    ...
    {
        zheevd_(jobz, uplo, n, (_MKL_Complex16*)a, lda, w, (_MKL_Complex16*)work, lwork, rwork, lrwork, iwork, liwork, info);
    }
    ...
    {
        zhegv_(itype, jobz, uplo, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, w, (_MKL_Complex16*)work, lwork, rwork, info);
    }
    ...
    {
        zhegvd_(itype, jobz, uplo, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, w, (_MKL_Complex16*)work, lwork, rwork, lrwork, iwork, liwork, info);
    }

    public unsafe void Zhesv(byte* uplo, int* n, int* nrhs, void* a, int* lda, int* ipiv, void* b, int* ldb, void* work, int* lwork, int* info)
    {
        zhesv_(uplo, n, nrhs, (_MKL_Complex16*)a, lda, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zhesvx_(fact, uplo, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)af, ldaf, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, lwork, rwork, info);
    }

    public unsafe void Zhetrd(byte* uplo, int* n, void* a, int* lda, double* d, double* e, void* tau, void* work, int* lwork, int* info)
    {
        zhetrd_(uplo, n, (_MKL_Complex16*)a, lda, d, e, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zhpgv_(itype, jobz, uplo, n, (_MKL_Complex16*)ap, (_MKL_Complex16*)bp, w, (_MKL_Complex16*)z, ldz, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zhpsv(byte* uplo, int* n, int* nrhs, void* ap, int* ipiv, void* b, int* ldb, int* info)
    {
        zhpsv_(uplo, n, nrhs, (_MKL_Complex16*)ap, ipiv, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zhpsvx_(fact, uplo, n, nrhs, (_MKL_Complex16*)ap, (_MKL_Complex16*)afp, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }
    ...
    {
        zpbsvx_(fact, uplo, n, kd, nrhs, (_MKL_Complex16*)ab, ldab, (_MKL_Complex16*)afb, ldafb, equed, s, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zpocon(byte* uplo, int* n, void* a, int* lda, double* anorm, double* rcond, void* work, double* rwork, int* info)
    {
        zpocon_(uplo, n, (_MKL_Complex16*)a, lda, anorm, rcond, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zpoequ(int* n, void* a, int* lda, double* s, double* scond, double* amax, int* info)
    {
        zpoequ_(n, (_MKL_Complex16*)a, lda, s, scond, amax, info);
    }
    ...
    {
        zporfs_(uplo, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)af, ldaf, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zposv(byte* uplo, int* n, int* nrhs, void* a, int* lda, void* b, int* ldb, int* info)
    {
        zposv_(uplo, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zposvx_(fact, uplo, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)af, ldaf, equed, s, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zpotf2(byte* uplo, int* n, void* a, int* lda, int* info)
    {
        zpotf2_(uplo, n, (_MKL_Complex16*)a, lda, info);
    }

    public unsafe void Zpotrf(byte* uplo, int* n, void* a, int* lda, int* info)
    {
        zpotrf_(uplo, n, (_MKL_Complex16*)a, lda, info);
    }

    public unsafe void Zpotri(byte* uplo, int* n, void* a, int* lda, int* info)
    {
        zpotri_(uplo, n, (_MKL_Complex16*)a, lda, info);
    }

    public unsafe void Zpotrs(byte* uplo, int* n, int* nrhs, void* a, int* lda, void* b, int* ldb, int* info)
    {
        zpotrs_(uplo, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)b, ldb, info);
    }

    public unsafe void Zppsv(byte* uplo, int* n, int* nrhs, void* ap, void* b, int* ldb, int* info)
    {
        zppsv_(uplo, n, nrhs, (_MKL_Complex16*)ap, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zppsvx_(fact, uplo, n, nrhs, (_MKL_Complex16*)ap, (_MKL_Complex16*)afp, equed, s, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zptsv(int* n, int* nrhs, double* d, void* e, void* b, int* ldb, int* info)
    {
        zptsv_(n, nrhs, d, (_MKL_Complex16*)e, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zptsvx_(fact, n, nrhs, d, (_MKL_Complex16*)e, df, (_MKL_Complex16*)ef, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }

    public unsafe void Zrot(int* n, void* cx, int* incx, void* cy, int* incy, double* c, void* s)
    {
        zrot_(n, (_MKL_Complex16*)cx, incx, (_MKL_Complex16*)cy, incy, c, (_MKL_Complex16*)s);
    }

    public unsafe void Zspmv(byte* uplo, int* n, void* alpha, void* ap, void* x, int* incx, void* beta, void* y, int* incy)
    {
        zspmv_(uplo, n, (_MKL_Complex16*)alpha, (_MKL_Complex16*)ap, (_MKL_Complex16*)x, incx, (_MKL_Complex16*)beta, (_MKL_Complex16*)y, incy);
    }

    public unsafe void Zspr(byte* uplo, int* n, void* alpha, void* x, int* incx, void* ap)
    {
        zspr_(uplo, n, (_MKL_Complex16*)alpha, (_MKL_Complex16*)x, incx, (_MKL_Complex16*)ap);
    }

    public unsafe void Zspsv(byte* uplo, int* n, int* nrhs, void* ap, int* ipiv, void* b, int* ldb, int* info)
    {
        zspsv_(uplo, n, nrhs, (_MKL_Complex16*)ap, ipiv, (_MKL_Complex16*)b, ldb, info);
    }
    ...
    {
        zspsvx_(fact, uplo, n, nrhs, (_MKL_Complex16*)ap, (_MKL_Complex16*)afp, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, rwork, info);
    }
    ...
    {
        zstedc_(compz, n, d, e, (_MKL_Complex16*)z, ldz, (_MKL_Complex16*)work, lwork, rwork, lrwork, iwork, liwork, info);
    }

    public unsafe void Zsteqr(byte* compz, int* n, double* d, double* e, void* z, int* ldz, double* work, int* info)
    {
        zsteqr_(compz, n, d, e, (_MKL_Complex16*)z, ldz, work, info);
    }

    public unsafe void Zsymv(byte* uplo, int* n, void* alpha, void* a, int* lda, void* x, int* incx, void* beta, void* y, int* incy)
    {
        zsymv_(uplo, n, (_MKL_Complex16*)alpha, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)x, incx, (_MKL_Complex16*)beta, (_MKL_Complex16*)y, incy);
    }

    public unsafe void Zsyr(byte* uplo, int* n, void* alpha, void* x, int* incx, void* a, int* lda)
    {
        zsyr_(uplo, n, (_MKL_Complex16*)alpha, (_MKL_Complex16*)x, incx, (_MKL_Complex16*)a, lda);
    }

    public unsafe void Zsysv(byte* uplo, int* n, int* nrhs, void* a, int* lda, int* ipiv, void* b, int* ldb, void* work, int* lwork, int* info)
    {
        zsysv_(uplo, n, nrhs, (_MKL_Complex16*)a, lda, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zsysvx_(fact, uplo, n, nrhs, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)af, ldaf, ipiv, (_MKL_Complex16*)b, ldb, (_MKL_Complex16*)x, ldx, rcond, ferr, berr, (_MKL_Complex16*)work, lwork, rwork, info);
    }

    public unsafe void Ztrti2(byte* uplo, byte* diag, int* n, void* a, int* lda, int* info)
    {
        ztrti2_(uplo, diag, n, (_MKL_Complex16*)a, lda, info);
    }

    public unsafe void Zung2r(int* m, int* n, int* k, void* a, int* lda, void* tau, void* work, int* info)
    {
        zung2r_(m, n, k, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, info);
    }

    public unsafe void Zungbr(byte* vect, int* m, int* n, int* k, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        zungbr_(vect, m, n, k, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, lwork, info);
    }

    public unsafe void Zunghr(int* n, int* ilo, int* ihi, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        zunghr_(n, ilo, ihi, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, lwork, info);
    }

    public unsafe void Zungqr(int* m, int* n, int* k, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        zungqr_(m, n, k, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, lwork, info);
    }

    public unsafe void Zungtr(byte* uplo, int* n, void* a, int* lda, void* tau, void* work, int* lwork, int* info)
    {
        zungtr_(uplo, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zunm2r_(side, trans, m, n, k, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)c, ldc, (_MKL_Complex16*)work, info);
    }
    ...
    {
        zunmqr_(side, trans, m, n, k, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)c, ldc, (_MKL_Complex16*)work, lwork, info);
    }
    ...
    {
        zunmtr_(side, uplo, trans, m, n, (_MKL_Complex16*)a, lda, (_MKL_Complex16*)tau, (_MKL_Complex16*)c, ldc, (_MKL_Complex16*)work, lwork, info);
    }
}